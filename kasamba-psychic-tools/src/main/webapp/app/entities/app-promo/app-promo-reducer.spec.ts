...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './app-promo.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPPROMO_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPPROMO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPPROMO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPPROMO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPPROMO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPPROMO actions', async () => {
      const expectedActions = [
        {
