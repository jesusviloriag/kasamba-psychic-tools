...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HOROSCOPELINK_LIST actions', async () => {
    ...
    it('dispatches FETCH_HOROSCOPELINK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HOROSCOPELINK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HOROSCOPELINK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HOROSCOPELINK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HOROSCOPELINK actions', async () => {
      const expectedActions = [
        {
