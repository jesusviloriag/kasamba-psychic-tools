...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FORTUNECOOKIE_LIST actions', async () => {
    ...
    it('dispatches FETCH_FORTUNECOOKIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FORTUNECOOKIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FORTUNECOOKIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FORTUNECOOKIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FORTUNECOOKIE actions', async () => {
      const expectedActions = [
        {
