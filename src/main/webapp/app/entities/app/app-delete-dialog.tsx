...
export const AppDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="kasambaPsychicToolsApp.app.delete.question">Are you sure you want to delete this App?</ModalBody>
      <ModalFooter>
